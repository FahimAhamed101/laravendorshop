...
class VendorProductController extends Controller
{
    ...
    public function Store(Request $request){
        ...
        Image::make($image)->resize(800,800)->save(base_path('public/media/product/'.$name_gen));
        $save_url = (base_path('public/media/product/'.$name_gen));
        ...
        foreach ($images as $img) {
            ...
            Image::make($img)->resize(800,800)->save(base_path('public/media/multiImage/'.$make_name));
            $uploadPath = base_path('public/media/multiImage/'.$make_name);
